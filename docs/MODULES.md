...
|------|---------|------|--------|------|------|---------|------|--------|------|
| M001 | games | planned | TBD | 0.1.0 | — | 1 | 0% | — | 否 |
| M002 | categories | planned | TBD | 0.1.0 | — | 2 | 0% | — | 否 |
| M003 | resources | planned | TBD | 0.1.0 | M001 | 6 | 0% | — | 否 |
| M004 | users | planned | TBD | 0.1.0 | — | 3 | 0% | — | 否 |
...
| Phase 1 | v0.1.2+ | M004, M002, M001, M005 | 核心基础模块 |
| Phase 2 | v0.2.x | M003, M007, M008, M006, M010, M011, M014 | 核心功能 |
| Phase 3 | v0.3.x | M012, M013, M009 | 社区功能 + SEO |
| Phase 4 | v0.4.x | M015 | 数据分析 |
