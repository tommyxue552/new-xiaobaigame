...
|------|---------|------|--------|------|------|---------|------|--------|------|
| M000 | database-foundation | completed | Codex | 0.2.0 | — | 0 | 100% | — | 否 |
| M001 | games | planned | TBD | 0.1.0 | M000 | 1 | 0% | — | 否 |
...
| Phase 1 | v0.2.x | M004, M002, M001, M005 | 核心基础模块 |
| Phase 2 | v0.3.x | M003, M007, M008, M006, M010, M011, M014 | 核心功能 |
| Phase 3 | v0.4.x | M012, M013, M009 | 社区功能 + SEO |
| Phase 4 | v0.5.x | M015 | 数据分析 |
